...
public class GroundProperties {
    ...
    public function GroundProperties(groundXML:XML) {
        ...
        if (groundXML.hasOwnProperty("MinDamage")) {
            this.minDamage_ = int(groundXML.MinDamage);
        }
        if (groundXML.hasOwnProperty("MaxDamage")) {
            this.maxDamage_ = int(groundXML.MaxDamage);
        }
        ...
        this.xOffset_ = !!Boolean(groundXML.hasOwnProperty("XOffset")) ? Number(Number(Number(groundXML.XOffset))) : Number(Number(0));
        this.yOffset_ = !!Boolean(groundXML.hasOwnProperty("YOffset")) ? Number(Number(Number(groundXML.YOffset))) : Number(Number(0));
        this.push_ = groundXML.hasOwnProperty("Push");
