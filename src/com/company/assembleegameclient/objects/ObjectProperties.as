...
public class ObjectProperties {
    ...
    public function ObjectProperties(objectXML:XML) {
        ...
        this.shadowSize_ = !!Boolean(objectXML.hasOwnProperty("ShadowSize")) ? int(int(objectXML.ShadowSize)) : int(int(100));
        ...
        this.angleCorrection_ = !!Boolean(objectXML.hasOwnProperty("AngleCorrection")) ? Number(Number(Number(objectXML.AngleCorrection) * Math.PI / 4)) : Number(Number(0));
        this.rotation_ = !!Boolean(objectXML.hasOwnProperty("Rotation")) ? Number(Number(objectXML.Rotation)) : Number(Number(0));
