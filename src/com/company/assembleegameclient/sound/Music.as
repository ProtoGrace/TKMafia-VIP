...
public class Music {
    ...
    public static function load():void {
        ...
        musicChannel_ = music_.play(0, int.MAX_VALUE, new SoundTransform(!!Boolean(Parameters.data.playMusic) ? Number(Number(0.3)) : Number(Number(0))));
    }

    public static function setPlayMusic(playMusic:Boolean):void {
        Parameters.data.playMusic = playMusic;
        Parameters.save();
