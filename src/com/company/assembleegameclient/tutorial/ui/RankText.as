...
public class RankText extends Sprite {
    ...
    public function RankText(numStars:int, largeText:Boolean, includePrefix:Boolean) {
        ...
        if (includePrefix) {
            this.prefix_ = new SimpleText(!!this.largeText_ ? int(int(18)) : int(int(16)), 11776947, false, 0, 0);
    ...
    public function draw(numStars:int):void {
        ...
        text = new SimpleText(!!this.largeText_ ? int(int(18)) : int(int(16)), 11776947, false, 0, 0);
