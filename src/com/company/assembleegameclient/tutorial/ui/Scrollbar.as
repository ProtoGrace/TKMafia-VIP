...
public class Scrollbar extends Sprite {
    ...
    public function Scrollbar(widthParam:int, heightParam:int, speed:Number = 1.0) {
        ...
        this.graphicsData_ = new <IGraphicsData>[this.backgroundFill_, this.path_, GraphicsUtil.END_FILL];
        super();
    ...
    public function setIndicatorSize(windowHeight:Number, totalHeight:Number, doSetPos:Boolean = true):void {
        var h:int = totalHeight == 0 ? int(int(this.indicatorRect_.height)) : int(int(windowHeight / totalHeight * this.indicatorRect_.height));
