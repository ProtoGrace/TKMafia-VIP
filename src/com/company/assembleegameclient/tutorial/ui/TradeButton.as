...
public class TradeButton extends Sprite {
    ...
    public function TradeButton(size:int, bWidth:int = 0) {
        ...
        this.graphicsData_ = new <IGraphicsData>[this.enabledFill_, this.path_, GraphicsUtil.END_FILL];
        this.barGraphicsData_ = new <IGraphicsData>[this.barFill_, this.path_, GraphicsUtil.END_FILL];
        this.outlineGraphicsData_ = new <IGraphicsData>[this.lineStyle_, this.path_, GraphicsUtil.END_STROKE];
        super();
        ...
        this.w_ = bWidth != 0 ? int(int(bWidth)) : int(int(this.text_.width + 12));
