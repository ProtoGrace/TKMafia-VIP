...
public class ChoiceBox extends Sprite {
    ...
    public function ChoiceBox(labels:Vector.<String>, values:Array, value:Object) {
        ...
        this.graphicsData_ = new <IGraphicsData>[this.internalFill_, this.lineStyle_, this.path_, GraphicsUtil.END_STROKE, GraphicsUtil.END_FILL];
        super();
        this.labels_ = labels;
        this.values_ = values;
    ...
    public function setValue(value:*):void {
        ...
        this.setSelected(this.selectedIndex_ == -1 ? 0 : this.selectedIndex_);
