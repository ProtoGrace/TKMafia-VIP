...
public class SkillTreeToolTip extends ToolTip {
    ...
    public function SkillTreeToolTip(title:String, description:String, width:int = 150, height:int = 25) {
        ...
        this.title_ = new SimpleText(16, 16777215, false, width, height).setBold(true).setText(title);
        this.title_.filters = [new DropShadowFilter(0, 0, 0)];
        this.title_.x = 0;
        this.title_.y = 0;
        addChild(this.title_);
        this.text_ = new SimpleText(14, 16777215, false, width, height).setBold(true).setText(description);
