...
public class PicView extends Sprite {
    ...
    public function PicView(bitmapData:BitmapData) {
        super();
        this.bitmap_ = new Bitmap(bitmapData);
        addChild(this.bitmap_);
        this.saveButton_ = new TextButton(16, "Save");
        addChild(this.saveButton_);
        this.closeButton_ = new TextButton(16, "Close");
