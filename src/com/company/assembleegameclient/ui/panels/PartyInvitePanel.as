package com.company.assembleegameclient.ui.panels {
   ...
   public class PartyInvitePanel extends Panel {
      ...
      public function PartyInvitePanel(gs:GameSprite, name:String, partyId:int) {
         super(gs);
         this.name_ = name;
         this.partyId = partyId;
         this.title_ = new SimpleText(16,16777215,false,WIDTH,0);
         this.title_.setBold(true);
         this.title_.htmlText = "<p align=\"center\">" + name + " invited you to\na Party!</p>";
      ...
      private function onAcceptClick(event:MouseEvent) : void {
         this.gs_.gsc_.joinParty(this.name_,this.partyId);
         dispatchEvent(new Event(Event.COMPLETE));
      }
   }
}
