...
public class BigSkillTreeToolTip extends ToolTip {
    ...
    public function BigSkillTreeToolTip(title:String, unlockableBy:String, unlockableByPos:int = 20, positiveBeneficts:String = null, positiveBenefictsPos:int = 0, negativeBeneficts:String = null, negativeBenefictsPos:int = 0, width:int = 225, height:int = 75) {
        ...
        this.title_ = new SimpleText(17, 16777215, false, width, height).setBold(true).setText(title);
        this.title_.filters = [new DropShadowFilter(0, 0, 0)];
        this.title_.x = 0;
        this.title_.y = 0;
        addChild(this.title_);
        this.unlockableby_ = new SimpleText(14, 8421504, false, width, height).setBold(false).setText(unlockableBy);
        ...
        this.positiveBeneficts_ = new SimpleText(14, 65280, false, width, height).setBold(false).setText(positiveBeneficts);
        ...
        this.negativeBeneficts_ = new SimpleText(14, 16711680, false, width, height).setBold(false).setText(negativeBeneficts);
