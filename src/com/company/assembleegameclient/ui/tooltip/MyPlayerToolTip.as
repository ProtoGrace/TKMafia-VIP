...
public class MyPlayerToolTip extends ToolTip {
    ...
    public function MyPlayerToolTip(accountName:String, charXML:XML, charStats:CharacterStats) {
        ...
        var numStars:int = charStats == null ? int(int(0)) : int(int(charStats.numStars()));
        ...
        var nextStarFame:int = FameUtil.nextStarFame(charStats == null ? int(int(0)) : int(int(charStats.bestFame())), 0);
        if (nextStarFame > 0) {
