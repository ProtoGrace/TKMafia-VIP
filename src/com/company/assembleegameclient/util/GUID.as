...
public class GUID {
    ...
    private static function sha1_kt(t:Number):Number {
        return t < 20 ? Number(Number(1518500249)) : t < 40 ? Number(Number(1859775393)) : t < 60 ? Number(Number(-1894007588)) : Number(Number(-899497514));
    }
    ...
    private static function str2binb(str:String):Array {
        ...
        for (var i:Number = 0; i < str.length * 8; i = i + 8) {
