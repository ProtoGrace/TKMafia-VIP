...
public class Triangle {
    ...
    private static function lineRectIntersect(x0:Number, y0:Number, x1:Number, y1:Number, l:Number, t:Number, r:Number, b:Number):Boolean {
        ...
        var topoverlap:Number = top_intersection > toptrianglepoint ? Number(Number(top_intersection)) : Number(Number(toptrianglepoint));
        var botoverlap:Number = bottom_intersection < bottomtrianglepoint ? Number(Number(bottom_intersection)) : Number(Number(bottomtrianglepoint));
