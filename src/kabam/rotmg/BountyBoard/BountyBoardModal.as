...
public class BountyBoardModal extends ModalPopup {
    ...
    public function BountyBoardModal(gs:GameSprite) {
        ...
        var color11:Number = 255;
        local1.clear();
        local1.lineStyle(thickness, color11);
        local1.beginFill(139, 0.8);
        ...
        var color2:Number = 16711680;
        local2.clear();
        local2.lineStyle(thickness, color2);
        local2.beginFill(9109504, 0.8);
        ...
        var color3:Number = 6950317;
        local3.clear();
        local3.lineStyle(thickness, color3);
        local3.beginFill(3152180, 0.8);
        ...
        this.easyBountyImage.width = this.easyBountyImage.measuredWidth * 2;
        this.easyBountyImage.height = this.easyBountyImage.measuredHeight * 2;
        this.easyBountyImage.filters = [new ColorMatrixFilter([0.2086, 0.5094, 0.072, 0, 0, 0.2086, 0.5094, 0.072, 0, 0, 0.2086, 0.5094, 0.072, 0, 0, 0, 0, 0, 1, 0])];
        ...
        this.easyBountyTitle = new SimpleText(18, 16777215, false, 230, 40, false);
        ...
        this.hardBountyTitle = new SimpleText(18, 16777215, false, 230, 40, false);
        ...
        this.hellBountyTitle = new SimpleText(18, 16777215, false, 230, 40, false);
        ...
        this.godlyBountyTitle = new SimpleText(18, 16777215, false, 230, 40, false);
        ...
        this.easyBountyDescription = new SimpleText(14, 16777215, false, 230, 140, false);
        ...
        this.hardBountyDescription = new SimpleText(14, 16777215, false, 230, 140, false);
        ...
        this.hellBountyDescription = new SimpleText(14, 16777215, false, 230, 140, false);
        ...
        this.godlyBountyDescription = new SimpleText(14, 16777215, false, 230, 140, false);
        ...
        this.easyRecommendSize = new SimpleText(12, 16776960, false, 230, 140, false);
        ...
        this.hardRecommendSize = new SimpleText(12, 16776960, false, 230, 140, false);
        ...
        this.hellRecommendSize = new SimpleText(12, 16776960, false, 230, 140, false);
        ...
        this.godlyRecommendSize = new SimpleText(12, 16776960, false, 230, 140, false);
        ...
        this.easyCost = new SimpleText(12,16776960,false,230,140,false);
        ...
        this.hardCost = new SimpleText(12,16776960,false,230,140,false);
        ...
        this.hellCost = new SimpleText(12,16776960,false,230,140,false);
        ...
        this.godlyCost = new SimpleText(12,16776960,false,230,140,false);
    ...
    public var subscriptionUI:SubscriptionUI;
    var gs_:GameSprite;
    ...
    private function showEasySubscription(e:MouseEvent):void {
        this.subscriptionUI = new SubscriptionUI("Preparation For: Easy Bounty", this.gs_);
        addChild(this.subscriptionUI);
        removeChild(this);
    }
}
}
