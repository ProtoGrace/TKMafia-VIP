...
public class SmallSkillTreeMediator extends Mediator {
    ...
    public function SmallSkillTreeMediator() {
        super();
    }
    [Inject]
    ...
    private function onSaved(evt:MouseEvent):void {
        var _local1:SmallSkillTree = null;
    ...
    private function onClicked1(arg1:MouseEvent):void {
        ...
        this.view.player.smallSkill1 = this.view.player.smallSkill1 + 1;
        this.view.player.points = this.view.player.points - 1;
        _local1 = this.messages.require(GameServerConnection.SMALLSKILLTREE) as SmallSkillTree;
    ...
    private function onClicked2(arg1:MouseEvent):void {
        ...
        this.view.player.smallSkill2 = this.view.player.smallSkill2 + 1;
        this.view.player.points = this.view.player.points - 1;
        _local1 = this.messages.require(GameServerConnection.SMALLSKILLTREE) as SmallSkillTree;
    ...
    private function onClicked3(arg1:MouseEvent):void {
        ...
        this.view.player.smallSkill3 = this.view.player.smallSkill3 + 1;
        this.view.player.points = this.view.player.points - 1;
        _local1 = this.messages.require(GameServerConnection.SMALLSKILLTREE) as SmallSkillTree;
    ...
    private function onClicked4(arg1:MouseEvent):void {
        ...
        this.view.player.smallSkill4 = this.view.player.smallSkill4 + 1;
        this.view.player.points = this.view.player.points - 1;
        _local1 = this.messages.require(GameServerConnection.SMALLSKILLTREE) as SmallSkillTree;
    ...
    private function onClicked5(arg1:MouseEvent):void {
        ...
        this.view.player.smallSkill5 = this.view.player.smallSkill5 + 1;
        this.view.player.points = this.view.player.points - 1;
        _local1 = this.messages.require(GameServerConnection.SMALLSKILLTREE) as SmallSkillTree;
    ...
    private function onClicked6(arg1:MouseEvent):void {
        ...
        this.view.player.smallSkill6 = this.view.player.smallSkill6 + 1;
        this.view.player.points = this.view.player.points - 1;
        _local1 = this.messages.require(GameServerConnection.SMALLSKILLTREE) as SmallSkillTree;
    ...
    private function onClicked7(arg1:MouseEvent):void {
        ...
        this.view.player.smallSkill7 = this.view.player.smallSkill7 + 1;
        this.view.player.points = this.view.player.points - 1;
        _local1 = this.messages.require(GameServerConnection.SMALLSKILLTREE) as SmallSkillTree;
    ...
    private function onClicked8(arg1:MouseEvent):void {
        ...
        this.view.player.smallSkill8 = this.view.player.smallSkill8 + 1;
        this.view.player.points = this.view.player.points - 1;
        _local1 = this.messages.require(GameServerConnection.SMALLSKILLTREE) as SmallSkillTree;
    ...
    private function onClicked9(arg1:MouseEvent):void {
        ...
        this.view.player.smallSkill9 = this.view.player.smallSkill9 + 1;
        this.view.player.points = this.view.player.points - 1;
        _local1 = this.messages.require(GameServerConnection.SMALLSKILLTREE) as SmallSkillTree;
    ...
    private function onClicked10(arg1:MouseEvent):void {
        ...
        this.view.player.smallSkill10 = this.view.player.smallSkill10 + 1;
        this.view.player.points = this.view.player.points - 1;
        _local1 = this.messages.require(GameServerConnection.SMALLSKILLTREE) as SmallSkillTree;
    ...
    private function onClicked11(arg1:MouseEvent):void {
        ...
        this.view.player.smallSkill11 = this.view.player.smallSkill11 + 1;
        this.view.player.points = this.view.player.points - 1;
        _local1 = this.messages.require(GameServerConnection.SMALLSKILLTREE) as SmallSkillTree;
    ...
    private function onClicked12(arg1:MouseEvent):void {
        ...
        this.view.player.smallSkill12 = this.view.player.smallSkill12 + 1;
        this.view.player.points = this.view.player.points - 1;
        _local1 = this.messages.require(GameServerConnection.SMALLSKILLTREE) as SmallSkillTree;
