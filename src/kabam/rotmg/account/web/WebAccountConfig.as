...
import kabam.rotmg.account.web.commands.OpenVerChangeCommand;
import kabam.rotmg.account.web.commands.VerChangeDialog;
import kabam.rotmg.account.web.commands.VerChangeDialogMediator;
...
public class WebAccountConfig implements IConfig {
    ...
    protected function mapCommands():void {
        ...
        this.commandMap.map(OpenVerChangeSignal).toCommand(OpenVerChangeCommand);
    ...
    protected function mapMediators():void {
        ...
        this.mediatorMap.map(VerChangeDialog).toMediator(VerChangeDialogMediator);
    }
