...
public class EmbeddedData {
    ...
    public static const objectFiles:Array = [new stackedItems(), new CustomMobs(), new abilitiesItems(), new ringItems(), new armorItems(), new weaponsItems(), new tieredItems(), new dat1(), new LostHalls(), new CustomBosses(), new wallsAndEnvironment(), new CaveOfAThousandTreasuresCXML(), new CustomItems(), new CustomShoots(), new Char16_16(), new PermapetsCXML(), new PlayersCXML()];
