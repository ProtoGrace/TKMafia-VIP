...
public class ReskinPanel extends Panel {
    ...
    private const title:SimpleText = this.makeTitle();

    private const button:TextButton = this.makeButton();

    public const reskin:Signal = new NativeMappedSignal(this.button, MouseEvent.CLICK);
