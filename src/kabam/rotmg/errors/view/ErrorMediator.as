...
public class ErrorMediator extends Mediator {
    ...
    private function addGlobalErrorListener():void {
        var eventDispatcher:IEventDispatcher = IEventDispatcher(this.loaderInfo[this.UNCAUGHT_ERROR_EVENTS]);
    ...
    private function handleUncaughtError(event:ErrorEvent):void {
        this.error.dispatch(event);
    }
}
}
