...
public class LegendFactory {
    ...
    public function makeLegend(xml:XML):Legend {
        ...
        var texture1:int = !!Boolean(xml.hasOwnProperty("Tex1")) ? int(int(xml.Tex1)) : int(int(0));
        var texture2:int = !!Boolean(xml.hasOwnProperty("Tex2")) ? int(int(xml.Tex2)) : int(int(0));
