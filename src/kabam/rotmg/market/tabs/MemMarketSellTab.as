package kabam.rotmg.market.tabs {
   ...
   public class MemMarketSellTab extends MemMarketTab {
      ...
      public function MemMarketSellTab(gameSprite:GameSprite) {
         var space:int = 0;
         var o:MemMarketInventoryItem = null;
         var item:MemMarketInventoryItem = null;
         super(gameSprite);
         ...
         for(var i:int = 4; i < this.gameSprite_.map.player_.equipment_.length; i++) {
      ...
      private function onSell(event:MouseEvent) : void {
         var i:MemMarketInventoryItem = null;
      ...
      private function onMyOffers(result:MarketMyOffersResult) : void {
         var x:MemMarketSellItem = null;
         var i:MarketData = null;
         var o:MemMarketSellItem = null;
         var item:MemMarketSellItem = null;
         ...
         for each(x in this.resultItems_) {
            x.dispose();
