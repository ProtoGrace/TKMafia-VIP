        ...
        for each(go in this.map.goDict_) {
            if (!(go.props_.noMiniMap_ || go == this.focus)) {
                ...
                if (player != null) {
                    if (player.isPaused()) {
                        fillColor = 8355711;
                    } else if(player.isPartyMember_) {
                        fillColor = Parameters.PARTY_MEMBER_COLOR;
                    } else if (player.isFellowGuild_) {
                        fillColor = 65280;
                    } else {
                        fillColor = 16776960;
                    }
                    ...
                    if (go.props_.isEnemy_) {
                        ...
                        if (go.props_.isSpecialEnemy_) {
                            if (go.objectType_ == 2357) {
                                fillColor = 65535;
                            } else if (go.objectType_ == 29517) {
                                fillColor = 14474460;
                            } else if (go.objectType_ == 18743) {
                                fillColor = 16747520;
                            }
                        }
                    } else {
